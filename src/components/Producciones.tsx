...
export default function Producciones() {
  ...
  return (
    <section id="producciones" className="py-8 md:py-36 bg-neutral-50">
                      ...
                      <div className="px-4 pb-4 md:px-6 md:pb-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-2">
                          {p.releases.map((release, ri) => (
                            <div
                              key={ri}
                              className="border border-neutral-100 rounded p-3 md:p-4 hover:border-neutral-200 transition-colors"
                            >
                              {release.coverImage ? (
                                <img
